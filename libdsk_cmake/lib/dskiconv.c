...
/* Similar mapping of MacRoman code page to UTF-8 sequences */
static const unsigned char macroman[128][4] =
{
	{0xc3, 0x84, 0x00 },		/* 80 */ 
	{0xc3, 0x85, 0x00 },		/* 81 */ 
	{0xc3, 0x87, 0x00 },		/* 82 */ 
	...
	{0xc3, 0xbb, 0x00 },		/* 9e */ 
	{0xc3, 0xbc, 0x00 },		/* 9f */ 
	{0xe2, 0x80, 0xa0, 0x00},	/* a0 */ 
	{0xc2, 0xb0, 0x00 },		/* a1 */ 
	{0xc2, 0xa2, 0x00 },		/* a2 */ 
	{0xc2, 0xa3, 0x00 },		/* a3 */ 
	{0xc2, 0xa7, 0x00 },		/* a4 */ 
	{0xe2, 0x80, 0x22, 0x00 },	/* a5 */ 
	{0xc2, 0xb6, 0x00 },		/* a6 */ 
	{0xc3, 0xbf, 0x00 },		/* a7 */ 
	{0xc2, 0xae, 0x00 },		/* a8 */ 
	{0xc2, 0xa9, 0x00 },		/* a9 */ 
	{0xe2, 0x84, 0xa2, 0x00 },	/* aa */ 
	{0xc2, 0xb4, 0x00 },		/* ab */ 
	{0xc2, 0xa8, 0x00 },		/* ac */ 
	{0xe2, 0x89, 0xa0, 0x00 },	/* ad */ 
	{0xc3, 0x86, 0x00 },		/* ae */ 
	{0xc3, 0x98, 0x00 },		/* af */ 
	{0xe2, 0x88, 0x9e, 0x00 },	/* b0 */ 
	{0xc2, 0xb1, 0x00 },		/* b1 */ 
	{0xe2, 0x89, 0xa4, 0x00 },	/* b2 */ 
	{0xe2, 0x89, 0xa5, 0x00 },	/* b3 */ 
	{0xc2, 0xa5, 0x00 },		/* b4 */ 
	{0xc2, 0xb5, 0x00 },		/* b5 */ 
	{0xe2, 0x88, 0x82, 0x00 },	/* b6 */ 
	{0xe2, 0x88, 0x91, 0x00 },	/* b7 */ 
	{0xe2, 0x88, 0x8f, 0x00 },	/* b8 */ 
	{0xcf, 0x80, 0x00 },		/* b9 */ 
	{0xe2, 0x88, 0xab, 0x00 },	/* ba */ 
	{0xc2, 0xaa, 0x00 },		/* bb */ 
	{0xc2, 0xba, 0x00 },		/* bc */ 
	{0xce, 0xa9, 0x00 },		/* bd */ 
	{0xc3, 0xa6, 0x00 },		/* be */ 
	...
	{0xc2, 0xa1, 0x00 },		/* c1 */ 
	{0xc2, 0xac, 0x00 },		/* c2 */ 
	{0xe2, 0x88, 0x9a, 0x00 },	/* c3 */ 
	{0xc6, 0x92, 0x00 },		/* c4 */ 
	{0xe2, 0x89, 0x88, 0x00 },	/* c5 */ 
	{0xe2, 0x88, 0x86, 0x00 },	/* c6 */ 
	{0xc2, 0xab, 0x00 },		/* c7 */ 
	{0xc2, 0xbb, 0x00 },		/* c8 */ 
	{0xe2, 0x80, 0xa6, 0x00 },	/* c9 */ 
	{0xc2, 0xa0, 0x00 },		/* ca */ 
	{0xc3, 0x80, 0x00 },		/* cb */ 
	{0xc3, 0x83, 0x00 },		/* cc */ 
	{0xc3, 0x95, 0x00 },		/* cd */ 
	{0xc5, 0x92, 0x00 },		/* ce */ 
	{0xc5, 0x93, 0x00 },		/* cf */ 
	{0xe2, 0x80, 0x93, 0x00 },	/* d0 */ 
	{0xe2, 0x80, 0x94, 0x00 },	/* d1 */ 
	{0xe2, 0x80, 0x9c, 0x00 },	/* d2 */ 
	{0xe2, 0x80, 0x9d, 0x00 },	/* d3 */ 
	{0xe2, 0x80, 0x98, 0x00 },	/* d4 */ 
	{0xe2, 0x80, 0x99, 0x00 },	/* d5 */ 
	{0xc3, 0xb7, 0x00 },		/* d6 */ 
	{0xe2, 0x97, 0x8a, 0x00 },	/* d7 */ 
	{0xc3, 0xbf, 0x00 },		/* d8 */ 
	{0xc5, 0xb8, 0x00 },		/* d9 */ 
	{0xe2, 0x81, 0x84, 0x00 },	/* da */ 
	{0xe2, 0x82, 0xac, 0x00 },	/* db */ 
	{0xe2, 0x80, 0xb9, 0x00 },	/* dc */ 
	{0xe2, 0x80, 0xba, 0x00 },	/* dd */ 
	{0xef, 0xac, 0x81, 0x00 },	/* de */ 
	{0xef, 0xac, 0x82, 0x00 },	/* df */ 
	{0xe2, 0x80, 0xa1, 0x00 },	/* e0 */ 
	{0xc2, 0xb7, 0x00 },		/* e1 */ 
	{0xe2, 0x80, 0x9a, 0x00 },	/* e2 */ 
	{0xe2, 0x80, 0x9e, 0x00 },	/* e3 */ 
	{0xe2, 0x80, 0xb0, 0x00 },	/* e4 */ 
	{0xc3, 0x82, 0x00 },		/* e5 */ 
	{0xc3, 0x8a, 0x00 },		/* e6 */ 
	{0xc3, 0x81, 0x00 },		/* e7 */ 
	{0xc3, 0x8b, 0x00 },		/* e8 */ 
...
int macroman_to_utf8(const char *src, char *dst, int limit)
{
	...
	while (*src)
	{
		...
		{
			l = strlen((char *)macroman[sc - 0x80]);
			count += l;
			if (!append((char *)macroman[sc - 0x80], l, dst, &dpos, &limit))
			{
				return count;
			}
		}
...
static unsigned char findroman(const unsigned char *t)
{
	int n;

	for (n = 0; n < 128; n++)
	{
		if (!strcmp((char *)macroman[n], (char *)t)) return 128 + n;
	}
	return 0xD7;
}
...
int utf8_to_macroman(const char *src, char *dst, int limit)
{
	...
	while (*src)
	{
		...
		if (token[0] <= 0x7F) /* Characters below 0x80 map */
		{		  /* as single bytes */
			count++;
			result = token[0];
		}
		...
		{
			result = 0xD7;	/* stray continuation byte,
					 * or overlong sequence */
		}
		else if (token[0] >= 0xC2 && token[0] < 0xE0)
		{
